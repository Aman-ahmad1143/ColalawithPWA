            ...
            <>
              ...
              {showUserDropdown && (
                <div className="absolute right-0 mt-2 w-[430px] bg-white rounded-3xl shadow-lg z-20 py-6 px-4 flex flex-col gap-3 text-gray-900" >
                  <Link to="/auth/login" className="bg-[#E53E3E] text-white rounded-xl py-3 font-semibold mb-2 cursor-pointer text-center">Login</Link>
                  <Link to="/auth/register" className="bg-gray-100 text-gray-900 rounded-xl py-3 font-semibold mb-4 cursor-pointer text-center">Register</Link>
                  <div className="flex flex-col gap-2">
                    <Link to="/settings/orders" className="flex items-center bg-[#E53E3E] rounded-2xl px-0  shadow-sm   relative">
                    ...
                    <Link to="/settings/saved-items" className="flex items-center bg-[#E53EE2] rounded-2xl px-0  shadow-sm  relative">
                    ...
                    <Link to="/settings/followed-stores" className="flex items-center bg-[#62e53e] rounded-2xl px-0  shadow-sm  relative">
                    ...
                    <Link to="/settings/reviews" className="flex items-center bg-[#4c3ee5] rounded-2xl px-0  shadow-sm  relative">
                    ...
                    <Link to="/settings/referrals" className="flex items-center bg-[#4c3ee5] rounded-2xl px-0  shadow-sm  relative">
                    ...
                    <Link to="/settings/support" className="flex items-center bg-[#E5863E] rounded-2xl px-0  shadow-sm  relative">
                    ...
                    <Link to="/settings/faqs" className="flex items-center bg-[#3EC9E5] rounded-2xl px-0  shadow-sm  relative">
                  ...
                  <div className="mt-4">
                    <div className="text-sm text-gray-900 mb-2">Others</div>
                      <Link to="/settings/loyalty-points" className="flex items-center bg-white hover:bg-[#e0dfdf] rounded-xl px-4 pl-2 py-3 shadow-sm mb-2 relative">
                        <span className="flex items-center justify-center w-13 h-9  rounded-l-xl"><img src={IMAGES.sealPercent} alt="Loyalty Points" className="w-7 h-7" /></span>
                        <div className="">Loyalty Points</div>
                    </Link>
                      <Link to="/settings/seller-leaderboard" className="flex items-center bg-white hover:bg-[#e0dfdf] rounded-xl px-4 pl-2 py-3 shadow-sm mb-2 relative">
                        <span className="flex items-center justify-center w-13 h-9  rounded-l-xl"><img src={IMAGES.ranking} alt="Seller Leaderboard" className="w-7 h-7" /></span>
