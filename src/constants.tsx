...
const IMAGES = {
  ...
  babyCategory: '/Baby.png',
  beautyAndHealth: '/beautyandhealth.png',
  catFashion: '/Cat_Fashion.png',
  computingCategory: '/Computing.png',
  electronicCategory: '/Electronic.png',
  electronicsCategory: '/electronics.png',
  fashionCategory: '/fashion.png',
  foodAndGrocery: '/foodandgrocery.png',
  gamingCategory: '/Gaming.png',
  gardenCategory: '/Garden.png',
  groceryCategory: '/Grocery.png',
  homeCategory: '/Home.png',
  mobile: '/mobile.png',
  phoneTablet: '/Phone_Tablet.png',
  servicesCategory: '/services.png',
  sportsCategory: '/Sports.png',
};
